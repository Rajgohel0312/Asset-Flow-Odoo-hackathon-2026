...
export const createAssetSchema = z.object({
  assetTag: z.string().min(2, 'Asset Tag must be at least 2 characters').max(50).optional(),
  ...
  purchaseDate: z
    ...
    .optional()
    .nullable(),
  purchaseCost: z.number().nonnegative('Purchase cost must be >= 0').optional().default(0),
  warrantyExpiry: z
    .string()
    .transform((val) => (val ? new Date(val) : null))
    .optional()
